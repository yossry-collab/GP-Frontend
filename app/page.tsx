  ...
  const steps = [
    {
      icon: Search,
      title: "Browse",
      desc: "Explore our collection of games, software, and gift cards",
    },
    {
      icon: CreditCard,
      title: "Pay Securely",
      desc: "256-bit SSL encryption with multiple payment options",
    },
    {
      icon: Zap,
      title: "Receive Instantly",
      desc: "Get your digital key delivered in seconds",
    },
    {
      icon: CheckCircle,
      title: "Enjoy",
      desc: "Redeem your code and start using immediately",
    },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-8 max-w-lg leading-relaxed">
                ...
                cards. Instant delivery, secure checkout, and the best prices.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-gray-300/80">
                <div className="flex items-center gap-2">
                  <Zap className="w-4 h-4 text-primary-400" /> Instant Delivery
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  <Globe className="w-4 h-4 text-primary-400" /> 150+ Countries
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <button
              onClick={() => router.push("/register")}
              className="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 font-medium flex items-center gap-1 transition-colors"
            >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/70 mb-8 max-w-md mx-auto">
                Join millions of gamers and get exclusive deals, instant
                delivery, and the best prices.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <button
                  onClick={() => router.push("/register")}
                  className="px-8 py-3.5 bg-white text-primary-700 rounded-xl font-bold text-sm hover:bg-gray-100 transition-colors shadow-lg"
                >
                  Create Free Account
                </button>
                <button
                  onClick={() => router.push("/login")}
                  className="px-8 py-3.5 bg-white/10 text-white border border-white/20 rounded-xl font-semibold text-sm hover:bg-white/20 transition-colors"
                >
                  Sign In
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            {[
              ...
              {
                title: "Account",
                links: ["Profile", "My Orders", "Wishlist", "Settings"],
              },
              {
                title: "Resources",
              ...
              <div key={col.title}>
                <h4 className="text-sm font-semibold mb-4 text-gray-900 dark:text-gray-300">
                  {col.title}
                </h4>
          ...
          <div className="border-t border-gray-200 dark:border-white/[0.06] pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              {["Visa", "MC", "PayPal", "Crypto"].map((p) => (
                <span
                  key={p}
                  className="px-2.5 py-1 bg-gray-100 dark:bg-white/[0.04] rounded text-[10px] text-gray-500 font-medium border border-gray-200 dark:border-white/[0.06]"
                >
                  {p}
                </span>
              ))}
